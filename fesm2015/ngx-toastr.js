...
import { Directive, ElementRef, NgModule, InjectionToken, defineInjectable, inject, Injectable, Inject, ComponentFactoryResolver, ApplicationRef, INJECTOR, NgZone, Injector, HostBinding, HostListener, Component } from '@angular/core';
...
ToastrService.ngInjectableDef = defineInjectable({ factory: function ToastrService_Factory() { return new ToastrService(inject(TOAST_CONFIG), inject(Overlay), inject(INJECTOR), inject(NgZone)); }, token: ToastrService, providedIn: "root" });
